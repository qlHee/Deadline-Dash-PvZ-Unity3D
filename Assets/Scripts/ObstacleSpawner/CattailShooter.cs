...
public class CattailShooter : MonoBehaviour
{
    ...
    public void UpdateScale()
    {
        ...
        {   
            // 保持碰撞体的高宽比例
            boxCollider.size = new Vector3(_scale, _scale * 1.5f, _scale);
            boxCollider.center = new Vector3(0f, _scale * 0.75f, 0f);
        }
        
        // 更新射击位置以匹配新的缩放
        if (muzzle != null)
        {
            muzzle.localPosition = new Vector3(0f, _scale * 1.0f, -_scale * 0.5f);
        }
    }
}
